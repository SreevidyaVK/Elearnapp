...
class Subject(models.Model):
    ...
    Sub_reg = models.ForeignKey(Registration, on_delete=models.CASCADE)
...
class Enrollment(models.Model):
    ...
    Certificate = models.FileField(max_length=200)
    Is_paid_subscription = models.BooleanField()
    enrol_reg = models.ForeignKey(Registration, on_delete=models.CASCADE)
...
class Learning_progress(models.Model):
    ...
    Learn_p_reg = models.ForeignKey(Registration, on_delete=models.CASCADE)
